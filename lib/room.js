function room(creatorId, roomId, nowTime){
    ...
    this.god_id = creatorId; //上帝的用户id，默认为创建者ID

    //private variable
    var _total = 0;//创建角色的总人数
    var _count = -1;//保存当前游戏人数
